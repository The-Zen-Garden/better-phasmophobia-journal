[
  ...
  },
  {
    ...
    behavior:
      "When a flame is extinguished near an Onryo, whether by itself or blown out by the ghost, there is a chance for the Onryo to begin a hunt, regardless of average sanity. In multiplayer, this chance to hunt increases each time it successfully kills a player during a hunt, with it having a near-guaranteed chance after killing two players.\nIn addition to this, the Onryo's normal hunt threshold is 60%, compared to the standard 50% baseline. If a lit candle, lighter, or campfire is near the ghost, it acts as a crucifix, preventing it from hunting with a range of 4m (versus a crucifix's 3m range). If it attempts to start a hunt in the lit candle's area, the hunt will fail and it will blow out the candle instead. Lit flames have priority to stop hunts over normal crucifixes. However, having a lit flame for this purpose also risks triggering an early hunt if the last flame goes out. Multiple lit flames in close proximity can potentially cause a chain reaction.\nThe Onryo also has a higher chance to blow out a flame than other ghosts, further complicating the task of countering one.\nContrary to the Journal quote, the Onryo does not attempt to escape from lit candles.\n",
    strategies:
      "The Onryo's aversion to fire is a double-edged sword. Sufficient candles and constant relighting may help to keep it from hunting, but having the Onryo within range of only one candle increases the risk of it hunting as a result of blowing it out. The latter is even riskier if one or more players have died, as a hunt is much more likely with one dead teammate and almost ensured with two.\nIf an Onryo is suspected, players will want to be vigilant while holding or being near any kind of fire, as the Onryo could start a hunt close to them if it blows the fire out itself.\n",
    excluded: false,
  },
  {
    name: 'Poltergeist',
  ...
  },
  {
    ...
    strategies:
      ' \t \t<a href="https://static.wikia.nocookie.net/phasmophobia/images/9/93/Obake-six-fingers.png/revision/latest?cb=20211027184004" class="image"><img alt="handprint with six fingers" src="https://static.wikia.nocookie.net/phasmophobia/images/9/93/Obake-six-fingers.png/revision/latest/scale-to-width-down/180?cb=20211027184004" decoding="async" width="180" height="180" class="thumbimage" data-image-name="Obake-six-fingers.png" data-image-key="Obake-six-fingers.png" data-src="https://static.wikia.nocookie.net/phasmophobia/images/9/93/Obake-six-fingers.png/revision/latest/scale-to-width-down/180?cb=20211027184004" /></a> \t \t\t \t\t\t \t\t \t\t \t\t \t\t\tA six-fingered handprint conclusively identifies an Obake. \t\t \t Each handprint from an Obake may have five or six fingers. The number of fingers may differ, even if the Obake touches the same surface multiple times. Because the six-fingered handprint is unique to the Obake, it conclusively identifies it. A five-fingered handprint does not necessarily rule Obake out, however.\nOn Nightmare, acquiring EMF Level 5 and Ghost Orbs allows for the Obake to be safely ruled out, as it always has Fingerprints as one of its two types of evidence.\n',
    excluded: false,
  },
  {
    name: 'Wraith',
